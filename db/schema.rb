...
ActiveRecord::Schema.define(:version => 20130311175835) do
  ...
  add_index "mentions", ["status_id"], :name => "index_mentions_on_status_id"
  ...
  add_index "statuses", ["direct"], :name => "index_statuses_on_direct"
